export default function AllActivitiesSkeletonSection() {
  return (
    ...
    >
      ...
      <div
        className="h-[41.4rem] w-[28.3rem] tablet:w-[22.1rem] rounded-[2rem]
    tablet:h-[34.7rem] mobile:w-[16.8rem] mobile:h-[28.3rem] skeleton mobile:hidden"
      />
      <div
        className="h-[41.4rem] w-[28.3rem] tablet:w-[22.1rem] rounded-[2rem]
    tablet:h-[34.7rem] mobile:w-[16.8rem] mobile:h-[28.3rem] skeleton mobile:hidden"
    ...
    tablet:h-[34.7rem] mobile:w-[16.8rem] mobile:h-[28.3rem] skeleton mobile:hidden"
      ...
      <div
        className="h-[41.4rem] w-[28.3rem] tablet:w-[22.1rem] rounded-[2rem]
    tablet:h-[34.7rem] mobile:w-[16.8rem] mobile:h-[28.3rem] skeleton mobile:hidden desktop:hidden"
      />
    </div>
  );
}
